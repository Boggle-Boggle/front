...
export const BookCover = (props: BookCoverProps) => {
  ...
  return (
    <div className={`relative inline-block ${className}`} style={{ aspectRatio: ratio }}>
      <div className={`relative size-full overflow-hidden border border-neutral-20 ${roundedClass}`}>
      ...
      {shadowRightTriangle && (
        <svg
          ...
          className="pointer-events-none absolute -right-[11px] bottom-0 z-30 w-4"
          aria-hidden="true"
