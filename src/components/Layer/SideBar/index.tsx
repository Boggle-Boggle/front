    ...
    mounted && (
      <>
        ...
        <div
          ...
          className={`absolute bottom-0 left-0 z-layer h-[calc(100%-3.375rem)] w-[calc(100%-3.75rem)] rounded-r-[20px] bg-neutral-0 ${visible ? 'animate-slideLeft' : 'animate-slideRight'}`}
        >
          {children}
        </div>
      </>
