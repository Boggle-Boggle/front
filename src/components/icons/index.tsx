...
export { default as IconCircleBan } from './CircleBan';
export { default as IconCancel } from './Cancel';
export { default as IconCancelMini } from './CancelMini';
...
export { default as IconCircleDeleteFilled } from './CircleDeleteFilled';
