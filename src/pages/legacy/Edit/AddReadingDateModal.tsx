          ...
          <section className="relative flex h-full w-full flex-col p-6">
            ...
            <div className="h-full w-full">
              ...
              <div className="flex w-full justify-between text-sm">
                <button
                  className={`flex h-[4.5rem] w-[48%] flex-col justify-around rounded-[10px] border-2 px-4 py-2 ${selected === 'complete' ? 'border-accent bg-accent text-accent bg-opacity-10' : 'border-main'}`}
                  type="button"
